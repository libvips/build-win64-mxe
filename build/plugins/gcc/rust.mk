...
$(PKG)_IGNORE   :=
# https://static.rust-lang.org/dist/rust-1.53.0-x86_64-unknown-linux-gnu.tar.gz.sha256
$(PKG)_VERSION  := 1.53.0
$(PKG)_CHECKSUM := 5e9e556d2ccce27aa8f01a528f1348bf8cdd34496c35ec2abf131660b9792fed
...
define $(PKG)_BUILD
    ...
    # https://github.com/rust-lang/rust/blob/0978a9eb99eca9f99889014b232f67ece898aadb/compiler/rustc_target/src/spec/windows_gnu_base.rs#L57
