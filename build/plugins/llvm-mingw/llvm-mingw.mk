...
$(PKG)_IGNORE   :=
# https://github.com/mstorsjo/llvm-mingw/tarball/faa0a22955f8093d5405597eaf2ec5ad486e3e41
$(PKG)_VERSION  := faa0a22
$(PKG)_CHECKSUM := 3b851aaded15a32b949df8f6d08c36b4722ea8cfe5c4d80688f45eae9c882260
...
define $(PKG)_PRE_BUILD
    ...
    # https://github.com/llvm/llvm-project/blob/llvmorg-14.0.0-rc2/llvm/tools/llvm-ar/llvm-ar.cpp#L1285-L1304
    ...
    # TODO(kleisauke): Remove this if we omit any dots from our target, see:
    # https://github.com/llvm/llvm-project/blob/llvmorg-14.0.0-rc2/llvm/tools/llvm-rc/llvm-rc.cpp#L266-L277
    (echo '#!/bin/sh'; \
    ...
    # aarch64 -> arm64
    # TODO(kleisauke): Remove this if we omit any dots from our target, see:
    # https://github.com/llvm/llvm-project/blob/llvmorg-14.0.0-rc2/llvm/lib/ToolDrivers/llvm-dlltool/DlltoolDriver.cpp#L97-L108
