...
define $(PKG)_BUILD
    ...
    mkdir -p '$(PREFIX)/$(TARGET)/$(PROCESSOR)-w64-mingw32'
    cp -rf '/opt/llvm-mingw/$(PROCESSOR)-w64-mingw32/include/' '$(PREFIX)/$(TARGET)/$(PROCESSOR)-w64-mingw32'
    cp -rf '/opt/llvm-mingw/$(PROCESSOR)-w64-mingw32/lib/' '$(PREFIX)/$(TARGET)/$(PROCESSOR)-w64-mingw32'
