...
define $(PKG)_BUILD_SHARED
   $(foreach LIB, c++ unwind, \
        $(INSTALL) -m644 '/opt/llvm-mingw/$(PROCESSOR)-w64-mingw32/lib/lib$(LIB).dll.a' '$(PREFIX)/$(TARGET)/lib'; \
        $(INSTALL) -m644 '/opt/llvm-mingw/$(PROCESSOR)-w64-mingw32/bin/lib$(LIB).dll' '$(PREFIX)/$(TARGET)/bin';)
endef
