...
define $(PKG)_BUILD
    ...
    # Update and regenerate the lockfile for built and cc
    # https://github.com/xiph/rav1e/issues/3395
    # https://github.com/rust-lang/cc-rs/issues/1167
    cargo update built cc --manifest-path='$(SOURCE_DIR)/Cargo.toml'
    ...
    cd '$(SOURCE_DIR)' && cargo cinstall \
        ...
        --target='$(PROCESSOR)-pc-windows-gnu$(if $(IS_LLVM),llvm)' \
